...
<head>
    ...
    <title>KoDeal - Business Category Bootstrap Responsive Template | Home :: W3layouts</title>
    <!--/google-fonts -->
    <link href="https://fonts.googleapis.com/css2?family=Hind+Siliguri:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <!--//google-fonts -->
    <!-- Template CSS -->
    <link rel="stylesheet" href="{{ asset('masjid') }}/assets/css/style-starter.css">
</head>
...
<body>
            ...
            <div class="row pt-sm-0 pt-5">
                <div class="col-lg-4 col-sm-6 mt-sm-0 m px-md-0 w3-gridhny-1 position-relative">
                    <div class="grids3-info">
                        <a href="#" class="d-block zoom"><img src="{{ asset('masjid') }}/assets/images/g1.jpg" alt="" class="img-fluid news-image"></a>
                ...
                <div class="col-lg-4 col-sm-6 mt-sm-0 px-md-0 w3-gridhny-1 position-relative">
                    <div class="grids3-info">
                        <a href="#blog" class="d-block zoom"><img src="{{ asset('masjid') }}/assets/images/g2.jpg" alt="" class="img-fluid news-image"></a>
                ...
                <div class="col-lg-4 col-sm-6 mt-lg-0 px-md-0 w3-gridhny-1 position-relative">
                    <div class="grids3-info">
                        <a href="#blog" class="d-block zoom"><img src="{{ asset('masjid') }}/assets/images/g3.jpg" alt="" class="img-fluid news-image"></a>
                        <div class="w3-grids3-info">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="w3shape position-relative">
                            <img src="{{ asset('masjid') }}/assets/images/ab1.jpg" alt="" class="radius-image img-fluid">
                        </div>
                    </div>
 ...
 <!--/services-->
                ...
                <div class="row cwp23-content mt-lg-5 mt-4">
                    ...
                    <div class="col-lg-6 cwp23-text mt-lg-0 mt-5 ps-lg-5">
                        <div class="cwp23-text-cols">
                            <div class="column">
                                <a href="#"><img src="{{ asset('masjid') }}/assets/images/g2.jpg" alt="" class="radius-image img-fluid"></a>
                            </div>
                            <div class="column">
                                <a href="#"><img src="{{ asset('masjid') }}/assets/images/g3.jpg" alt="" class="radius-image img-fluid"></a>
                            </div>
                            <div class="column">
                                <a href="#"><img src="{{ asset('masjid') }}/assets/images/g4.jpg" alt="" class="radius-image img-fluid"></a>
                            </div>
                            <div class="column">
                                <a href="#"><img src="{{ asset('masjid') }}/assets/images/g5.jpg" alt="" class="radius-image img-fluid"></a>
                            </div>
                        ...
                        <div class="col-lg-6 item">
                            <div class="testimonial-content">
                                <div class="testimonial">
                                    ...
                                    <div class="testi-des">
                                        <div class="test-img"><img src="{{ asset('masjid') }}/assets/images/team1.jpg" class="img-fluid" alt="client-img">
                                        </div>
                        ...
                        <div class="col-lg-6 item">
                            <div class="testimonial-content">
                                <div class="testimonial">
                                    ...
                                    <div class="testi-des">
                                        <div class="test-img"><img src="{{ asset('masjid') }}/assets/images/team2.jpg" class="img-fluid" alt="client-img">
                                        </div>
                                        <div class="peopl align-self">
                                            <h3>Julia sakura</h3>
                                            <p class="indentity">Example City</p>
    ...
    <!-- Js scripts -->
    <!-- Template JavaScript -->
    <script src="{{ asset('masjid') }}/assets/js/jquery-3.3.1.min.js"></script>
    <script src="{{ asset('masjid') }}/assets/js/theme-change.js"></script>
    ...
    <!-- //bootstrap -->
    <script src="{{ asset('masjid') }}/assets/js/bootstrap.min.js"></script>
